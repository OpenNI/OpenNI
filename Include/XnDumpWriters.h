...
// Types
//---------------------------------------------------------------------------
typedef union XnDumpWriterFileHandle
{
	void* pInternal;
...
typedef struct XnDumpWriter
{
	...
	void (XN_CALLBACK_TYPE* Write)(void* pCookie, XnDumpWriterFileHandle hFile, const XnUInt8* pBuffer, XnUInt32 nBufferSize);
...
public:
	...
	virtual void Write(XnDumpWriterFileHandle hFile, const XnUInt8* pBuffer, XnUInt32 nBufferSize) = 0;
...
private:
	...
	static void XN_CALLBACK_TYPE WriteCallback(void* pCookie, XnDumpWriterFileHandle hFile, const XnUInt8* pBuffer, XnUInt32 nBufferSize)
	{
		XnDumpWriterBase* pThis = (XnDumpWriterBase*)pCookie;
