...
If NOT "%BuildRepository%" == "" (       
	Echo Copying file to %BuildRepository%\%5\Win%bits%\OpenNI-%MAJOR_VERSION%.%MINOR_VERSION%.%MAINTENANCE_VERSION%.%BUILD_VERSION%
	rmdir /S /q %BuildRepository%\%5\Win%bits%\OpenNI-%MAJOR_VERSION%.%MINOR_VERSION%.%MAINTENANCE_VERSION%.%BUILD_VERSION%
	mkdir %BuildRepository%\%5\Win%bits%\OpenNI-%MAJOR_VERSION%.%MINOR_VERSION%.%MAINTENANCE_VERSION%.%BUILD_VERSION%	
	xcopy /E /I %finalDir% %BuildRepository%\%5\Win%bits%\OpenNI-%MAJOR_VERSION%.%MINOR_VERSION%.%MAINTENANCE_VERSION%.%BUILD_VERSION%
)
