...
result = os.system("make -C Redist/Samples/Build CXX=arm-none-linux-gnueabi-g++ > "+SCRIPT_DIR+"/Output/BuildSmpRelease.txt")
...
# Build project solution
result = os.system("make CFG=Debug -C Redist/Samples/Build CXX=/home/ronid/CodeSourcery/Sourcery_G++_Lite/bin/arm-none-linux-gnueabi-g++ > "+SCRIPT_DIR+"/Output/BuildSmpDebug.txt")
